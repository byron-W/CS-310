...
public final class Game extends JPanel {
    ...
    /**
     * Creating a placeholder for the randomizer data.
     */
    private static Random rand = new Random();

    /**
     * Creating a placeholder for the array of color data.
     */
    private final static Color[] color = {
            Color.black, Color.red, Color.green, Color.blue, Color.cyan, Color.magenta, Color.orange, Color.yellow,
            Color.pink, Color.white
    };

    /**
     * Draws the block and board.
     * 
